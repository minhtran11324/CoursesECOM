...
<head>
    ...
    <meta http-equiv="refresh" content="3;url=/PetsAccessories/puclic/index.php">
...
<main class="auth-container">
    <div class="auth-box" style="text-align: center;">
        ...
        <a href="/PetsAccessories/puclic/index.php" class="btn-auth" style="display: inline-block; text-decoration: none; width: auto; padding: 12px 30px;">
